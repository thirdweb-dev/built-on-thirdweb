...
export const IconLogo: FC<Omit<AspectRatioProps, 'ratio'>> = ({
  color,
  ...props
}) => {
  return (
    <AspectRatio ratio={516 / 321} {...props}>
      <svg fill="none" viewBox="0 0 516 321">
...
export const Wordmark: FC<Omit<AspectRatioProps, 'ratio'>> = ({
  color = 'var(--chakra-colors-wordmark)',
  ...props
}) => {
  return (
    <AspectRatio ratio={1377 / 267} {...props}>
      <svg fill="none" viewBox="0 0 1377 267">
        <path
          clipRule="evenodd"
...
export const Logo: FC<ILogoProps> = ({
  ...
  return (
    <Stack align="center" as="h2" direction="row">
      {hideIcon ?? <IconLogo flexShrink={0} w={[9, 9, 10]} />}
